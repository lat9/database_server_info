...
<?php
//-bof-database_server_info-lat9  *** 1 of 3 ***
?>
#db-quicklink, #db-quicklink a { text-align: center; font-size: 20px; padding-bottom: 10px; }
...
<?php
//-bof-database_server_info-lat9  *** 2 of 3 ***
?>
<p id="db-quicklink"><?php echo TEXT_DATABASE_QUICKLINK; ?></p>
<?php
//-eof-database_server_info-lat9  *** 2 of 3 ***
?>
...
<?php
//-bof-database_server_info-lat9  *** 3 of 3 ***
?>
...
<?php
//-eof-database_server_info-lat9  *** 3 of 3 ***
?>
