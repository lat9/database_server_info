...
//-bof-database_server_info-lat9  *** 1 of 1 ***
define ('TEXT_DATABASE_QUICKLINK', 'Click <a href="#db-h2">here</a> to view the database configuration variables.');
...
//-eof-database_server_info-lat9  *** 1 of 1 ***
